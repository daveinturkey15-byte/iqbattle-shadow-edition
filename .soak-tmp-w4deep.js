...
IQ.Align.begin('soak-seed-w4deep',4096);
...
console.log(JSON.stringify({maxDepthReached:maxD,hpLeft:hp,score,errs,deaths,picksFired:fired,modifierCounts:mods,packsLoaded:Object.keys(IQ.Hooks._packs||{}).length,packIds:Object.keys(IQ.Hooks._packs||{})}));
