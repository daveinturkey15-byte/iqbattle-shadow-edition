...
for(let round=1;round<=60;round++){
  ...
  try{
    ...
    console.log('ROUND',round,'pre-hp',hp,'pre-score',score,JSON.stringify(ms));ms=H.dispatch('answer',{round,world,align,hp,score,streak,timerLen:30,optCount:8,rng,runId:'soak',seed:round,res:{correct,picked:2,correctIdx:correct?2:0}});
